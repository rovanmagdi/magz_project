...
<Box position={"relative"} >
    <CategoryLabelBox sx={{backgroundColor:"#22B8B3"}} >Lifestyle</CategoryLabelBox>
    <HorizontalLineBox sx={{backgroundColor:"#22B8B3"}}></HorizontalLineBox>
    </Box>    <StyledLifestyleCard >
      <CardActionArea>
        <CardMedia
